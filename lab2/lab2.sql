...
CREATE TABLE data_plan_spec (
	data_plan_name VARCHAR(64) NOT NULL PRIMARY KEY,
...
CREATE TABLE connections (
	connection_id INT GENERATED ALWAYS AS IDENTITY NOT NULL PRIMARY KEY,
	...
	CONSTRAINT fk_connections
		...
		REFERENCES data_plan_spec (data_plan_name),
	CONSTRAINT fk_prov
